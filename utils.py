...
def plot_image(image, boxes, k):
    ...
    for box in boxes:
        ...
        cv2.rectangle(im,
                      ...
                      (int(upper_left_x * width + box[2] * width), int(upper_left_y * height + box[3] * height)),
                      (0,0,255),
                      2)
    cv2.imshow('111', im)
    cv2.imwrite('D:/Study/_4_sem/_kursach/test_images_web/' + str(k) + '.jpg', im)
